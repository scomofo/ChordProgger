...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BEeuEW5W.js
var router_BEeuEW5W_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DIm6gVk3.css";
...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Play the changes — a chord-progression player for songwriting practice."
			},
			{
				name: "theme-color",
				content: "#0e0d0b"
...
var $$splitComponentImporter = () => import("./routes-Dmw4I2f8.mjs");
...
//#endregion
export { getRouter, router_BEeuEW5W_exports as t };
